...
export default function Sidebar({ children, getPath }: Props) {
  ...
  const handleSignOut = async () => {
    const confirmSignOut = confirm("You sure want to sign out?")
  ...
  return (
    <div className="h-screen bg-gray-100 text-gray-800 flex flex-col md:flex-row">
      <button
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="p-4 border-t border-gray-100">
            ...
            className="w-full px-3 py-2 rounded-md bg-red-100 text-red-600 font-medium cursor-pointer hover:bg-red-200 transition">
              Sign Out
            </button>
          </div>
        </div>
